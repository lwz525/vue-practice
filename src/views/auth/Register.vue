      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body" data-validator-form>
          ...
          <div class="form-group">
            ...
            <input type="password" v-validator.required="{ regex: /^\w{6,16}$/, error: '密码要求 6 ~ 16 个单词字符' }" class="form-control" placeholder="请填写密码">
          </div>
          <div class="form-group">
...
.captcha{font-size: 24px;font-weight: boldl}
</style>  