import { isGenerated } from "C:/Users/Administrator/AppData/Local/Microsoft/TypeScript/2.9/node_modules/@types/babel-types";
...
function showError(el,error){
    ...
    const errprElement=getErrorElement(el)
    if(error===undefined){
...
export default{
    bind(el,binding,vnode){
        ...
        isGenerated(el,binding,vnode){
            const {value,modifiers}=binding
            const form=el.closeset('[data-validator-form]')
